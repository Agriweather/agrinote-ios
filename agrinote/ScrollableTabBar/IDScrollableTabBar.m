...
-(void)setFrame:(CGRect)frame{
    ...
    if ([_buttonsArray count] > 0) {
        ...
        int rightCount = (int)[_buttonsArray count] - leftCount - 1;
    ...
    if ([_buttonsArray count] > 0) {
        ...
        int rightCount = (int)[_buttonsArray count] - 1 - leftCount;
        for (int i = 0; i < [_buttonsArray count]; i++) {
            IDScrollableTabBarItem *item = [_buttonsArray objectAtIndex:i];
            CGRect rect = item.frame;
            if ((self.selectedItem - leftCount <= i && i <= self.selectedItem && self.selectedItem >= leftCount) || (self.selectedItem < leftCount && (self.selectedItem > i || self.selectedItem + rightCount < i))) {
                ...
                if (diffIndex > leftCount) {
                    diffIndex = (int)[_buttonsArray count] - diffIndex;
                }
...
- (id)initWithFrame:(CGRect)frame itemWidth : (float) itemWidth items : (NSMutableArray *)arrayItems{
    
    UIImage *defaultBackGroundImage = [UIImage imageNamed:@"grayBackground"];
    UIImage *defaultArchImage = [UIImage imageNamed:@"grayArch"];
    ...
    if (self) {
        ...
        //center
        _centerImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"grayCenter"]];
        rect = _centerImageView.frame;
        rect.origin.x = self.frame.size.width / 2.f - rect.size.width / 2.f;
        [_centerImageView setFrame:rect];
        ...
        //shadowImages
        UIImageView *imgViewLeft = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"grayShadowLeft"]];
        ...
        UIImageView *imgView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"grayShadowRight"]];
...
-(void)createButtons : (NSArray *)arrayItems{
    ...
    int leftCount = (int)[_buttonsArray count] / 2.f - 0.5f;
    int rightCount = (int)[_buttonsArray count] - leftCount - 1;
